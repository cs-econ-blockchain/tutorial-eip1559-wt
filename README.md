...
|--------------------|:--------------------:|:--------------------:|
| **Data Source**    | Observed by nodes set on the blockchain stored on [GitHub](https://github.com/SciEcon/EIP1559)|[Kaggle - Ethereum Blockchain](https://www.kaggle.com/datasets/bigquery/ethereum-blockchain)|
